...
<body class="bg-gray-100 flex flex-col min-h-screen">
    ...
    <!-- Centered Title and Description for Projecten Page -->
    <main class="flex-grow flex flex-col items-center justify-center mt-4 text-center">
        ...
        <p class="mt-4 text-gray-600 text-base md:text-lg max-w-xl px-4 leading-relaxed">
            Discover our various projects aimed at enhancing community engagement and cultural exchange. Stay tuned for more information!
        </p>
    </main>
