...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            .menu {
                display: block; /* Always show the menu on small screens */
            }
        }
...
<body class="bg-gray-100 flex flex-col min-h-screen">
    ...
    <main class="flex-grow flex flex-col items-center justify-center mt-4 text-center">
        <h1 class="text-4xl md:text-6xl font-extrabold text-gray-800 mb-4"> <!-- Responsive font size -->
            Stichting Asha
        </h1>
        <p class="mt-4 text-gray-600 text-base md:text-lg max-w-xl px-4 leading-relaxed"> <!-- Responsive text size -->
